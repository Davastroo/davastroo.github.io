...
(function() {
	...
	// Initialize "On Visible" animations.
		...
		onvisible.add('h1.style3, h2.style3, h3.style3, p.style3', { style: 'fade-up', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('.container.style1', { style: 'fade-in-background', speed: 1500, intensity: 1, threshold: 3, delay: 375, replay: false });
		onvisible.add('.container.style1 > .wrapper > .inner', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style10, h2.style10, h3.style10, p.style10', { style: 'fade-up', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('.buttons.style2', { style: 'fade-up', speed: 1000, intensity: 1, threshold: 3, delay: 0, stagger: 250, staggerSelector: ':scope > li', replay: false });
